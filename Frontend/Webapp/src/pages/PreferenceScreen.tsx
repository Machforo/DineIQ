...
const questions = [
  { id: 1, q: "Dietary Type?", icon: <Utensils className="text-primary" />, options: ["Vegetarian", "Non-Vegetarian", "Vegan", "Eggetarian", "Jain"] },
  { id: 2, q: "Preferred Indian Bread?", icon: <Sandwich className="text-[#8B4513]" />, options: ["Roti", "Kulcha", "Naan"] },
  { id: 3, q: "Favorite beverages?", icon: <Coffee className="text-[#6F4E37]" />, options: ["Chaas", "Lassi", "Juice", "Soda"] },
  { id: 4, q: "Dessert Preferences?", icon: <IceCream className="text-accent" />, options: ["Ice-Creams", "Sweets"] },
];
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div className="bg-white px-6 pt-12 pb-6 shadow-sm">
        <div className="max-w-md mx-auto">
          <h1 className="text-xl font-black text-gray-900 mb-1 font-serif">Harvest <span className="text-primary">DineIQ</span></h1>
          <p className="text-gray-500 text-xs font-medium">Personalizing your organic experience</p>

          {/* Progress Bar */}
          <div className="mt-6">
            <div className="flex justify-between items-end mb-2">
              <span className="text-primary font-bold text-xs font-serif">Question {currentStep + 1}/4</span>
          ...
          <div className="space-y-4">
            {questions[currentStep].options.map((option, index) => (
              <button
                ...
                className="w-full py-4 px-6 text-left text-sm font-bold text-gray-700 border-2 border-gray-50 bg-gray-50/50 rounded-2xl hover:border-primary hover:bg-primary/5 hover:text-primary transition-all duration-200 flex justify-between items-center group active:scale-[0.97]"
              >
                {option}
