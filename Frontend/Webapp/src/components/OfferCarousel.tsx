        ...
        {offers.map((offer) => {
          ...
          return (
            <div
              ...
              className={`cursor-pointer relative flex-shrink-0 w-[85vw] max-w-[380px] h-52 rounded-2xl overflow-hidden snap-center ${offer.bgColor || 'bg-gray-800'} active:scale-95 transition-transform`}
            >
              <img
                src={offer.image}
                alt={offer.title}
